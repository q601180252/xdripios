...
enum LibreProAlgorithm {
    ...
    // 调试：打印关键 calibratinoInfoValue
    print("[LibreProAlgorithm] calibratinoInfoValue: [0]=\(glucoseTrendArray[0].calibratinoInfoValue), [3]=\(glucoseTrendArray[3].calibratinoInfoValue), [8]=\(glucoseTrendArray[8].calibratinoInfoValue), [9]=\(glucoseTrendArray[9].calibratinoInfoValue), [11]=\(glucoseTrendArray[11].calibratinoInfoValue), [13]=\(glucoseTrendArray[13].calibratinoInfoValue)")
    
    if glucoseTrendArray[0].calibratinoInfoValue == 0 || glucoseTrendArray[9].calibratinoInfoValue == 0 {
        dAdd1 = 0
        bTrendArrow = false
        print("[LibreProAlgorithm] dAdd1 检查失败, bTrendArrow=false")
    } else {
    ...
    if glucoseTrendArray[13].calibratinoInfoValue == 0 || glucoseTrendArray[8].calibratinoInfoValue == 0 {
        dAdd2 = 0
        bTrendArrow = false
        print("[LibreProAlgorithm] dAdd2 检查失败, bTrendArrow=false")
    } else {
    ...
    if glucoseTrendArray[11].calibratinoInfoValue == 0 || glucoseTrendArray[3].calibratinoInfoValue == 0 {
        dAdd3 = 0
        bTrendArrow = false
        print("[LibreProAlgorithm] dAdd3 检查失败, bTrendArrow=false")
    } else {
    ...
    print("[LibreProAlgorithm] bTrendArrow=\(bTrendArrow), dCurr1=\(dCurr1)")
    if !bTrendArrow {
        trendArrow = 0
        print("[LibreProAlgorithm] bTrendArrow=false, 强制设置 trendArrow=0")
    } else {
